...
class _SidebarState extends State<Sidebar>
  ...
  final List<_SidebarItem> items = [
    _SidebarItem(Icons.access_time, "Activity", "/activity", children: [
      _SidebarSubItem("Activity Logs", "/activity/logs"),
      _SidebarSubItem("Login History", "/activity/login-history"),
    ]),
    _SidebarItem(Icons.admin_panel_settings, "Roles", "/roles", children: [
      _SidebarSubItem("Roles", "/roles/add"),
      _SidebarSubItem("All New", "/roles/list"),
    ]),
    _SidebarItem(Icons.group, "Users", "/users", children: [
      _SidebarSubItem("Add User", "/users/add"),
      _SidebarSubItem("All Users", "/users/list"),
    ]),
    _SidebarItem(Icons.business, "Vendors", "/vendors", children: [
      _SidebarSubItem("Add Vendor", "/vendors/add"),
      _SidebarSubItem("Vendor List", "/vendors/list"),
    ]),
    _SidebarItem(Icons.request_page, "Expense Approval", "/expense-approval",
        children: [
    ...
    _SidebarItem(Icons.payment, "Payment Notes", "/payment-notes",
        children: [
          _SidebarSubItem("All Payment Notes", "/payment-notes/list"),
          _SidebarSubItem("Approval Rules", "/payment-notes/rules"),
        ]),
    _SidebarItem(Icons.card_travel, "Travel Reimbursement", "/travel",
        children: [
    ...
    _SidebarItem(Icons.account_balance, "Bank RTGS/NEFT", "/bank",
        children: [
    ...
    _SidebarItem(Icons.work, "Designation", "/designation", children: [
      _SidebarSubItem("Create", "/designation/create"),
      _SidebarSubItem("All Designations", "/designation/list"),
    ]),
    _SidebarItem(Icons.apartment, "Department", "/department", children: [
